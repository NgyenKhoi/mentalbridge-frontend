...
const heroTopics = [
  ...
  },
  {
    ...
    description:
      'Nhận diện điều khó nói và xem chuyên gia theo lĩnh vực bạn quan tâm khi cần một người đồng hành.',
  },
  {
    label: 'Căng thẳng',
  ...
  {
    label: 'Sang chấn',
    eyebrow: 'Một không gian riêng tư',
    title: 'Bạn không cần đi qua một mình.',
    description:
      'MentalBridge giúp bạn nhìn lại điều đang trải qua và xem các lựa chọn hỗ trợ tiếp theo.',
  },
  {
    label: 'Kiệt sức',
        ...
        <div className="hero-trust" aria-label="Thông tin nền tảng">
          <div className="trust-item">
            ...
            <span className="trust-label">
              sàng lọc trải nghiệm 14 ngày gần đây
            </span>
          </div>
          <div className="trust-item">
