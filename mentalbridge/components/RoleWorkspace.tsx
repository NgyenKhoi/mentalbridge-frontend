...
const adminSections: Record<string, Section> = {
  ...
  assessments: {
    label: 'Quản lý bài đánh giá',
    description: 'Quản lý bộ câu hỏi, phiên bản và trạng thái phát hành.',
    rows: [
      {
        id: 'as1',
        title: 'PHQ-9 · phq9-vi-vn-capstone-v1',
        meta: '9 câu hỏi · Đang hiển thị',
        status: 'Đã xuất bản',
        detail:
          'Bộ câu hỏi sàng lọc được Care quản lý theo phiên bản, nguồn và quy trình publication gate.',
      },
      {
        id: 'as2',
        title: 'DASS-21 · phiên bản 0.9',
        meta: '21 câu hỏi · Chưa công khai',
        status: 'Bản nháp',
        detail:
          'Bản nháp chưa hiển thị với người dùng và cần hoàn thành kiểm tra an toàn trước khi phát hành.',
      },
    ],
  ...
  content: {
    ...
    description: 'Quản lý nội dung đã được rà soát trước khi công bố.',
    rows: [
      {
        id: 'ct1',
  ...
  return (
    ...
    >
      <motion.aside
        ...
        layout
        initial={false}
        transition={{ layout: { type: 'spring', stiffness: 330, damping: 34 } }}
      >
      ...
      >
        ...
        <div className="role-content">
          ...
          {role === 'specialist' && sectionKey === 'profile' && (
            <SpecialistProfileManager />
          )}
          {role === 'specialist' && sectionKey === 'availability' && (
            <SpecialistAvailabilityManager
              onCreate={() => setShowAvailabilityModal(true)}
            />
          )}
          {role === 'specialist' && sectionKey === 'appointments' && (
            <SpecialistAppointmentsManager
              rows={section.rows}
              onCreate={() => setShowAppointmentModal(true)}
              onSelect={setSelected}
            />
          )}
          {role === 'specialist' && sectionKey === 'clients' && (
            <SpecialistClientsManager rows={section.rows} />
          )}
          {role === 'specialist' && sectionKey === 'messages' && (
            <SpecialistMessagesManager />
          )}
          {role === 'specialist' && sectionKey === 'earnings' && (
            <SpecialistEarningsManager />
          )}
          {role === 'admin' && sectionKey === 'users' && (
            <AdminUsersManager
              onSelect={setSelected}
              onNotice={(message) => {
                setToast(message)
          ...
          {role === 'admin' && sectionKey === 'specialists' && (
          ...
          {role === 'admin' && sectionKey === 'assessments' && (
            <AdminAssessmentsManager
              onNotice={(message) => {
                setToast(message)
                window.setTimeout(() => setToast(''), 3200)
              }}
          ...
          {role === 'admin' && sectionKey === 'payments' && (
          ...
          {role === 'admin' && sectionKey === 'dashboard' && (
          ...
          {role === 'admin' && sectionKey === 'moderation' && (
          ...
          {role === 'admin' && sectionKey === 'appointments' && (
          ...
          >
            <div className="role-heading">
              ...
              <button
                ...
                onClick={() => {
                  if (role === 'specialist' && sectionKey === 'appointments')
                    return setShowAppointmentModal(true)
                  if (role === 'specialist' && sectionKey === 'availability')
                    return setShowAvailabilityModal(true)
      ...
      {showAppointmentModal && (
        <div className="role-modal-wrap availability-modal-wrap appointment-modal-wrap">
          <button
            className="role-drawer-backdrop"
            aria-label="Đóng"
            ...
            <div className="availability-modal-content">
              <div className="availability-form-grid">
                <div className="availability-form-field">
                  <label htmlFor="appointment-client">Khách hàng</label>
                  <select
                  ...
                  >
                    ...
                    <option value="Trần Gia Hân">Trần Gia Hân</option>
                ...
                <div className="availability-form-row">
                  ...
                  <div className="availability-form-field">
                    <label htmlFor="appointment-start">Giờ bắt đầu</label>
                    <input
                      type="time"
                ...
                <div className="availability-form-row">
                  <div className="availability-form-field">
                    <label htmlFor="appointment-duration">Thời lượng</label>
                    <select
                  ...
                  <div className="availability-form-field">
                    <label htmlFor="appointment-format">Hình thức tư vấn</label>
                    <select
                    ...
                    >
                      ...
                      <option value="Tại phòng tư vấn">Tại phòng tư vấn</option>
                      <option value="Điện thoại">Điện thoại</option>
                    </select>
                  </div>
                </div>
                <div className="availability-form-field">
                  <label htmlFor="appointment-notes">Ghi chú (tùy chọn)</label>
                  <textarea
              ...
              <div className="availability-info-box appointment-info-box">
                ...
                <div>
                  ...
                  <p>
                    Khách hàng có thể nhận thông báo sau khi cuộc hẹn được xác
                    nhận.
                  </p>
                </div>
              </div>
              <div className="availability-summary">
                ...
                <div className="availability-summary-grid">
                  <div className="availability-summary-item">
                    ...
                    <strong>{appointmentForm.client || 'Chưa chọn'}</strong>
                  </div>
                  <div className="availability-summary-item">
                    <small>Thời gian</small>
                    <strong>
                      {appointmentForm.startTime
                        ? `${appointmentForm.startTime} · ${appointmentForm.duration} phút`
                        : 'Chưa chọn'}
                    </strong>
                  </div>
                </div>
      ...
      {showAvailabilityModal && (
        <div className="role-modal-wrap availability-modal-wrap">
          <button
            className="role-drawer-backdrop"
            aria-label="Đóng"
          ...
          <div className="availability-modal">
            <div className="availability-modal-header">
              <div>
                ...
                <h2>2 yêu cầu đặt lịch</h2>
                <p>
                  Xác định phạm vi nhận tư vấn - chỉ bạn có quyền xem và cập
                  nhật.
                </p>
              </div>
              <button
            ...
            <div className="availability-modal-content">
              <div className="availability-form-grid">
                <div className="availability-form-field">
                  <label htmlFor="availability-date">Ngày khả dụng</label>
                  <input
                    type="date"
                ...
                <div className="availability-form-row">
                  <div className="availability-form-field">
                    <label htmlFor="availability-start">Giờ bắt đầu</label>
                    <input
                      type="time"
                  ...
                  <div className="availability-form-field">
                    <label htmlFor="availability-end">Giờ kết thúc</label>
                    <input
                      type="time"
                      id="availability-end"
                ...
                <div className="availability-form-field">
                  <label htmlFor="availability-duration">
                ...
                <div className="availability-form-field">
                  <label htmlFor="availability-notes">Ghi chú (tùy chọn)</label>
                  <textarea
              ...
              <div className="availability-info-box">
                ...
                <div>
                  <strong>4 check-in mới</strong>
                  <p>
                    Có 2 phản hồi mới từ kế hoạch theo dõi của bạn - hãy xem
                    lại.
                  </p>
                </div>
              </div>
              <div className="availability-summary">
                <h3>Mốt ngày càn bàng</h3>
                <div className="availability-summary-grid">
                  <div className="availability-summary-item">
                  ...
                  <div className="availability-summary-item">
                    ...
                    <strong>
                      ...
                      availabilityForm.duration
                        ? Math.floor(
                            (parseInt(availabilityForm.endTime.split(':')[0]) *
                              60 +
                              parseInt(availabilityForm.endTime.split(':')[1]) -
                              parseInt(
                                availabilityForm.startTime.split(':')[0],
                              ) *
                                60 -
                              parseInt(
                                availabilityForm.startTime.split(':')[1],
                              )) /
                              parseInt(availabilityForm.duration),
                          )
                        : '0'}{' '}
                      phiên
                    </strong>
