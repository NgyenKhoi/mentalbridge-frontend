...
const INITIAL_ASSESSMENTS: Assessment[] = [
  { id: 'AS-PHQ9', name: 'PHQ-9', fullName: 'Patient Health Questionnaire-9', purpose: 'Theo dõi triệu chứng trầm cảm trong 2 tuần gần đây.', questions: 9, duration: '3–5 phút', version: 'v2.1', updated: '24/08/2026', completions: 4281, status: 'Đã xuất bản', owner: 'Hội đồng chuyên môn' },
  { id: 'AS-GAD7', name: 'GAD-7', fullName: 'Generalized Anxiety Disorder-7', purpose: 'Theo dõi mức độ lo âu và căng thẳng.', questions: 7, duration: '3–5 phút', version: 'v1.8', updated: '20/08/2026', completions: 3614, status: 'Đã xuất bản', owner: 'Hội đồng chuyên môn' },
...
export default function AdminAssessmentsManager({ onNotice }: Props) {
  ...
  return <div className="admin-assessments-manager">
    ...
    <section className="aam-stats" aria-label="Tổng quan bài đánh giá"><article className="primary"><span>Đang hoạt động</span><strong>3</strong><p>Hiển thị với người dùng</p></article><article><span>Lượt hoàn thành</span><strong>9.747</strong><p>Trong 30 ngày gần nhất</p></article><article><span>Tỷ lệ hoàn thành</span><strong>84,6%</strong><p>↑ 2,3% so với tháng trước</p></article><article className="review"><span>Cần rà soát</span><strong>2</strong><p>1 bản nháp · 1 phiên bản mới</p></article></section>
