...
const SPECIALISTS = [
  {
    ...
    initials: 'NL',
    role: 'Tâm lý lâm sàng',
    focus: 'Trầm cảm · Lo âu',
    price: '500.000đ',
    tone: 'sage',
    avatar: '👩‍⚕️',
  },
...
export default function NewAppointmentModal({
  ...
  const [specialistId, setSpecialistId] = useState(
    initialSpecialistId &&
      SPECIALISTS.some((item) => item.id === initialSpecialistId)
      ? initialSpecialistId
      : SPECIALISTS[0].id,
  )
  ...
  const selectedSpecialist =
    SPECIALISTS.find((item) => item.id === specialistId) ?? SPECIALISTS[0]
  ...
  return (
    <AnimatePresence>
      <>
        <motion.button
          className="new-booking-backdrop"
          ...
          >
            <header className="new-booking-header">
              <div>
                ...
                <h2 id="new-booking-title">Chọn một thời gian phù hợp</h2>
                <p>Bạn có thể thay đổi hoặc hủy lịch trước phiên tư vấn.</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="new-booking-scroll">
              <div className="new-booking-form">
                <fieldset className="new-booking-specialists">
                  <legend>
                    <span>01</span>
                    <div>
                      <strong>Chọn chuyên gia</strong>
                      <small>Người bạn muốn đồng hành trong phiên này</small>
                    </div>
                  </legend>
                  <div>
                ...
                <fieldset className="new-booking-schedule">
                  <legend>
                    ...
                    <div>
                      ...
                      <small>Các khung giờ đang nhận lịch</small>
                    </div>
                  </legend>
                  <label>
                  ...
                  <div className="new-booking-times">
                    <span>Khung giờ</span>
                    <div>
                      {TIME_SLOTS.map((slot) => (
                        <button
                ...
                <fieldset className="new-booking-format">
                  <legend>
                    <span>03</span>
                    <div>
                      <strong>Hình thức tư vấn</strong>
                      <small>Chọn cách bạn cảm thấy thoải mái nhất</small>
                    </div>
                  </legend>
                  <div>
                    {FORMATS.map((item) => (
                ...
                <label className="new-booking-notes">
                  <span>
                    Điều bạn muốn chuyên gia biết <small>(tùy chọn)</small>
                  </span>
                  <textarea
                    value={notes}
                    ...
                    rows={3}
                    maxLength={400}
                    placeholder="Ví dụ: Chủ đề bạn muốn trao đổi hoặc điều khiến bạn lo lắng..."
                  />
                  <small>{notes.length}/400</small>
                </label>
                {error && (
                  <p className="new-booking-error" role="alert">
                    {error}
                  </p>
                )}
              </div>
              ...
              <aside className="new-booking-summary">
                ...
                <div className="new-booking-summary-person">
                  <i className={selectedSpecialist.tone}>
                    {selectedSpecialist.initials}
                  </i>
                  <div>
                    <strong>{selectedSpecialist.name}</strong>
                    <small>{selectedSpecialist.role}</small>
                  </div>
                </div>
                <dl>
                  <div>
                  ...
                  <div>
                    <dt>Thời gian</dt>
                    <dd>
                      {time ? `${time} – ${getEndTime(time)}` : 'Chưa chọn'}
                    </dd>
                  </div>
                  <div>
                    <dt>Hình thức</dt>
                ...
                <div className="new-booking-price">
                ...
                <p>
                  <i>i</i>
                  <span>
                    Lịch hẹn sẽ ở trạng thái <strong>Chờ xác nhận</strong> cho
                    đến khi chuyên gia phản hồi.
                  </span>
                </p>
              </aside>
            </div>
            ...
            <footer className="new-booking-footer">
              <p>
                Bằng việc đặt lịch, bạn đồng ý với chính sách thay đổi và hủy
                lịch.
              </p>
              <div>
                ...
                <button onClick={submit} disabled={isSubmitting}>
                  {isSubmitting ? 'Đang gửi yêu cầu...' : 'Xác nhận đặt lịch'}{' '}
                  <span>→</span>
                </button>
              </div>
            </footer>
