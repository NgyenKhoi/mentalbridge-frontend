        ...
        >
          <header className="reschedule-header">
            <div>
              ...
              <p>
                Chuyên gia sẽ xác nhận lại sau khi bạn gửi yêu cầu đổi lịch.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="reschedule-scroll">
            <section className="reschedule-person">
              ...
              <div>
                ...
                <small>Mã lịch hẹn #{appointment.code}</small>
              </div>
              <i>Đã xác minh</i>
            </section>

            <section
              className="reschedule-comparison"
              aria-label="So sánh lịch hẹn hiện tại và lịch hẹn mới"
            >
              <article>
              ...
              <article className={date && time ? 'ready' : ''}>
                ...
                <p>
                  {time ? `${time} - ${getEndTime(time)}` : 'Chưa chọn giờ'} ·{' '}
                  {format}
                </p>
              </article>
            </section>
            ...
            <div className="reschedule-form">
              <fieldset className="reschedule-schedule">
                <legend>
                  <span>01</span>
                  <div>
                    <strong>Ngày và giờ mới</strong>
                    <small>Chọn một khung giờ phù hợp với bạn</small>
                  </div>
                </legend>
                <label>
              ...
              <fieldset className="reschedule-formats">
                <legend>
                  ...
                  <div>
                    ...
                    <small>Bạn có thể thay đổi hình thức cho lịch mới</small>
                  </div>
                </legend>
                <div>
                  {FORMATS.map((item) => (
              ...
              <aside className="reschedule-note">
                <i>i</i>
                <p>
                  <strong>Trạng thái sẽ chuyển về “Chờ xác nhận”</strong>
                  <span>
                    Lịch hiện tại vẫn được giữ cho đến khi yêu cầu đổi lịch được
                    gửi thành công.
                  </span>
                </p>
              </aside>
          ...
          <footer className="reschedule-footer">
            <p>
              Hãy kiểm tra lại ngày, giờ và hình thức tư vấn trước khi gửi yêu
              cầu.
            </p>
            <div>
