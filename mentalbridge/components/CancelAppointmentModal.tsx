      ...
      <div className="cancel-appointment-shell">
        ...
        >
          <header className="cancel-appointment-header">
            <div className="cancel-appointment-icon" aria-hidden="true">
              !
            </div>
            <div>
          ...
          <div className="cancel-appointment-content">
            <section
              className="cancel-appointment-summary"
              aria-label="Lịch hẹn sắp hủy"
            >
              <div className="cancel-appointment-avatar">
                {appointment.avatar}
              </div>
              <div>
                ...
                <small>
                  {appointment.type} · Mã #{appointment.code}
                </small>
              </div>
            </section>
            ...
            <fieldset className={error ? 'has-error' : ''}>
              ...
              {error && (
                <p className="cancel-appointment-error" role="alert">
                  {error}
                </p>
              )}
            </fieldset>
            ...
            <label className="cancel-appointment-note">
              <span>
                Ghi chú thêm <small>Không bắt buộc</small>
              </span>
              <textarea
                value={note}
            ...
            <aside className="cancel-appointment-policy">
              ...
              <p>
                <strong>Lưu ý về chính sách hủy</strong>
                <span>
                  Việc hoàn phí, nếu có, sẽ được xử lý theo chính sách của lịch
                  hẹn. Bạn vẫn có thể đặt lại một khung giờ khác sau khi hủy.
                </span>
              </p>
            </aside>
          </div>
