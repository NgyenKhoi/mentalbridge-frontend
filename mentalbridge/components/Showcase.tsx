      ...
      <div className="wrap">
        ...
        <div className="showcase-card reveal">
          ...
          <div className="showcase-badge sb-1 float-card">
            <div className="float-inner">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M12 3c3 3 5 6 5 9a5 5 0 0 1-10 0c0-3 2-6 5-9Z"/></svg>
              <div><div className="fc-title">7 ngày liên tiếp</div><div className="fc-value">Đã ghi nhật ký</div></div>
            </div>
          </div>
          <div className="showcase-badge sb-2 float-card">
            <div className="float-inner">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M9 11l2 2 4-4M20 7v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7l4-4h8l4 4Z"/></svg>
              <div><div className="fc-title">Điểm PHQ-9</div><div className="fc-value">Giảm 30% sau 1 tháng</div></div>
            </div>
          </div>
          ...
          <div className="phone" ref={phoneRef}>
            ...
            <div className="phone-screen">
              <div className="phone-slide" data-slide="1">
                ...
                <div className="chat-bubble bot">Hôm nay bạn cảm thấy thế nào?</div>
              ...
              <div className="phone-slide" data-slide="2">
                ...
                <div className="mood-row">
                  <div className="mood-dot">😔</div><div className="mood-dot active">🙂</div><div className="mood-dot">😄</div><div className="mood-dot">😴</div><div className="mood-dot">😣</div>
                </div>
        ...
        <div className="value-row">
          <div className="value-item reveal reveal-d1">
            <div className="value-icon fi-teal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M4 5.5C4 4.7 4.7 4 5.5 4H16l4 4v10.5c0 .8-.7 1.5-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5v-13Z"/><path d="M8 10h8M8 14h5"/></svg></div>
            <div><h4>Bạn viết, chúng tôi lắng nghe</h4><p>Chỉ vài dòng nhật ký mỗi ngày, không cần &quot;đúng chuẩn&quot; hay hoàn hảo.</p></div>
          </div>
          <div className="value-item reveal reveal-d2">
            <div className="value-icon fi-amber"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a5 5 0 0 0-5 5c0 2 1 3 1 5v2h8v-2c0-2 1-3 1-5a5 5 0 0 0-5-5ZM9 19h6M10 22h4"/></svg></div>
            <div><h4>AI thấu hiểu điều chưa nói ra</h4><p>Công nghệ xử lý ngôn ngữ nhận ra cảm xúc ẩn sau câu chữ của bạn.</p></div>
          </div>
