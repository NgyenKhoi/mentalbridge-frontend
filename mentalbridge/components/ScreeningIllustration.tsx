...
export default function ScreeningIllustration({ className = '' }: ScreeningIllustrationProps) {
  return (
    ...
    >
      ...
      <g transform="rotate(-8 145 225)">
        ...
        {[0, 1, 2, 3, 4, 5].map((row) => (
          <g key={`phq-row-${row}`} transform={`translate(52 ${198 + row * 23})`}>
            ...
            <path d="M20 6h142" stroke="#9bbcaf" strokeWidth="2" strokeLinecap="round" />
      ...
      <path d="M270 402h80" stroke="#c99842" strokeWidth="5" strokeLinecap="round" />
      <path d="m336 388 18 14-18 14" fill="none" stroke="#c99842" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />

      <g>
        <rect x="42" y="454" width="248" height="212" rx="24" fill="#fffdf9" stroke="#d8cfb8" strokeWidth="2" />
        <text x="66" y="494" fill="#8a5a1f" fontFamily="Arial, sans-serif" fontSize="12" letterSpacing="2" fontWeight="700">KẾT QUẢ RÕ RÀNG</text>
        <rect x="70" y="528" width="188" height="92" rx="12" fill="#f3f6ef" stroke="#c5d9cd" />
        ...
        <text x="164" y="644" textAnchor="middle" fill="#526b63" fontFamily="Arial, sans-serif" fontSize="12">Điểm số dễ hiểu</text>
      </g>

      <g>
        <rect x="328" y="454" width="250" height="212" rx="24" fill="#f6fbf7" stroke="#b9d5c7" strokeWidth="2" />
        <circle cx="453" cy="525" r="42" fill="#f5e6c6" />
        <path d="M431 529c0-22 11-37 23-37 14 0 25 15 25 37 0 12-8 18-12 22h-24c-4-4-12-10-12-22Z" fill="#f0c76c" stroke="#8a5a1f" strokeWidth="3" />
        <path d="M440 558h28M443 568h22" stroke="#8a5a1f" strokeWidth="4" strokeLinecap="round" />
        <path d="M453 472v-17M418 484l-13-13M488 484l13-13M407 521h-18M499 521h18" stroke="#3d7a6e" strokeWidth="4" strokeLinecap="round" />
        <text x="453" y="614" textAnchor="middle" fill="#1e4a43" fontFamily="Georgia, serif" fontSize="22" fontWeight="700">Hiểu tín hiệu</text>
        <text x="453" y="640" textAnchor="middle" fill="#526b63" fontFamily="Arial, sans-serif" fontSize="12">để chọn bước tiếp theo</text>
      </g>
