...
/** A small, dependency-free infographic for the PHQ-9 preview. */
export default function ScreeningIllustration({
  ...
  return (
    <svg
      ...
      viewBox="0 0 620 820"
      role="img"
      aria-label="Minh họa hành trình từ trả lời PHQ-9 đến xem kết quả sàng lọc"
