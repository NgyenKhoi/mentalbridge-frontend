            ...
            >
              <header className="specialist-profile-header">
                <div className="specialist-profile-identity">
                  <div
                    className={`specialist-profile-avatar ${specialist.tone}`}
                  >
                    <svg viewBox="0 0 130 70" aria-hidden="true">
                      <path d="M7 62Q65-8 123 62" />
                    </svg>
                    <span>{specialist.initials}</span>
                    <i aria-label="Hồ sơ đã xác minh">
                      <CheckIcon />
                    </i>
                  </div>
                  <div>
                    ...
                    <div className="specialist-profile-tags">
                ...
                <button
                  className="specialist-profile-close"
                  onClick={onClose}
                  aria-label="Đóng"
                >
                  ×
              ...
              <div className="specialist-profile-scroll">
                <section
                  className="specialist-profile-metrics"
                  aria-label="Thông tin chuyên môn"
                >
                  <article>
                  ...
                  <article>
                    <span>Đánh giá</span>
                    <strong>
                      <i>★</i> {specialist.rating}
                    </strong>
                    <small>{specialist.reviews} nhận xét</small>
                  </article>
                  <article>
                    <span>Phiên tư vấn</span>
                    <strong>{specialist.sessions}+</strong>
                  </article>
                </section>
                ...
                <div className="specialist-profile-layout">
                  ...
                  <aside className="specialist-profile-aside">
                    ...
                    <section
                      className={specialist.available ? 'available' : 'busy'}
                    >
                      <span>Lịch gần nhất</span>
                      <strong>{specialist.nextSlot}</strong>
                      <small>
                        {specialist.available
                          ? 'Đang nhận lịch hẹn mới'
                          : 'Chưa mở thêm lịch mới'}
                      </small>
                    </section>
                  </aside>
                </div>
              ...
              <footer className="specialist-profile-footer">
                ...
                <div>
                  <button
                    className="specialist-profile-later"
                    onClick={onClose}
                  >
                    Để sau
                  </button>
                  {specialist.available ? (
                    <Link
                      ...
                      className="specialist-profile-book"
                    >
                      Đặt lịch tư vấn <span>→</span>
                    </Link>
                  ) : (
                    <button className="specialist-profile-disabled" disabled>
                      Chưa có lịch trống
                    </button>
                  )}
                </div>
