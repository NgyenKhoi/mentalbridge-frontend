        ...
        <section className="analytics-chart-card">
          <div className="analytics-chart-head">
            <div>
              ...
              <h2>Xu hướng tâm trạng tuần này</h2>
            </div>
            <div className="analytics-chart-actions">
              <div className="analytics-legend">
                <span className="terra">Không tốt</span>
                <span className="amber">Bình thường</span>
                <span className="teal">Tốt</span>
                <span className="deep">Tuyệt vời</span>
              </div>
              <button onClick={() => setIsEmotionProgressOpen(true)}>
                Xem chi tiết <b>→</b>
              </button>
            </div>
          </div>
          <div className="analytics-chart-scroll">
            <svg
              ...
              viewBox="0 0 780 245"
              role="img"
              aria-label="Biểu đồ tâm trạng từ thứ Hai đến Chủ nhật"
            >
              <defs>
              ...
              <text x="0" y="49" className="analytics-axis">
                Tuyệt vời
              </text>
              <text x="18" y="94" className="analytics-axis">
                Tốt
              </text>
              <text x="0" y="139" className="analytics-axis">
                Bình thường
              </text>
              <text x="0" y="184" className="analytics-axis">
                Không tốt
              </text>
              <path
                className="analytics-area"
                d="M55 90C104 90 104 135 153 135C210 135 210 45 267 45C324 45 324 90 380 90C437 90 437 180 493 180C550 180 550 90 607 90C664 90 664 45 720 45L720 190L55 190Z"
              />
              <path
                className="analytics-line"
                d="M55 90C104 90 104 135 153 135C210 135 210 45 267 45C324 45 324 90 380 90C437 90 437 180 493 180C550 180 550 90 607 90C664 90 664 45 720 45"
              />
              {points.map((point, index) => (
                <g
                  key={point.day}
                  className={`analytics-point ${point.tone}`}
                  style={
                    {
        ...
        <aside className="analytics-insights">
          <div className="analytics-insight-title">
            ...
            <div>
              ...
              <small>
                Thông tin hỗ trợ theo dõi, không phải kết luận chuyên môn
              </small>
            </div>
          </div>
          <ul>
