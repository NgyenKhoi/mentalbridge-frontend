...
const CHAT_MESSAGES = [
  {
    ...
    sender: 'bot',
    content:
      'Chào bạn! Tôi đã xem nhật ký của bạn tuần này. Có vẻ như bạn đang có nhiều tiến bộ tích cực.',
    time: '10:15',
  },
  {
    id: 2,
    sender: 'user',
    content:
      'Dạ vâng, em cảm thấy tốt hơn nhiều sau khi áp dụng các kỹ thuật thầy hướng dẫn.',
    time: '10:17',
  },
  {
    id: 3,
    sender: 'bot',
    content:
      'Tuyệt vời! Điều đó cho thấy bạn đang thực hành đều đặn. Hãy tiếp tục duy trì nhé.',
    time: '10:18',
  },
  {
    id: 4,
...
export default function MessagesPage() {
  ...
  return (
    ...
    >
      {/* Conversations List */}
      <div
        className="feature-card messages-list-panel"
        style={{
          padding: '1rem',
          display: 'flex',
          ...
          {CONVERSATIONS.map((conv) => (
            <motion.button
              ...
              style={{
                ...
                border: '1px solid',
                borderColor:
                  selectedConv === conv.id ? 'var(--teal)' : 'var(--line)',
                background:
                  selectedConv === conv.id ? 'var(--teal-pale)' : 'transparent',
                cursor: 'pointer',
                textAlign: 'left',
                position: 'relative',
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    <div
                      className="message-conversation-name"
                      style={{
                        fontWeight: 600,
                        fontSize: '0.95rem',
                      }}
                  ...
                  <div
                    className="message-conversation-preview"
                    style={{
                      fontSize: '0.85rem',
                      opacity: 0.7,
                      whiteSpace: 'nowrap',
      ...
      {/* Chat Area */}
      <div
        className="feature-card messages-chat-panel"
        style={{
          padding: 0,
          display: 'flex',
          flexDirection: 'column',
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div
              className="messages-online-label"
              style={{
                fontSize: '0.85rem',
                opacity: 0.6,
                display: 'flex',
